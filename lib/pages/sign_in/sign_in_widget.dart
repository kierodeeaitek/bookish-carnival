...
import '/components/dialog_modals/reset_password/reset_password_widget.dart';
            ...
            child: Column(
              ...
              children: [
                ...
                Row(
                  ...
                  children: [
                    wrapWithModel(
                      model: _model.darkIconButtonBigModel1,
                      updateCallback: () => safeSetState(() {}),
                      child: DarkIconButtonBigWidget(
                        icon: Icon(
                    ...
                    wrapWithModel(
                      model: _model.darkIconButtonBigModel2,
                      updateCallback: () => safeSetState(() {}),
                      child: DarkIconButtonBigWidget(
                        icon: FaIcon(
                    ...
                    wrapWithModel(
                      model: _model.darkIconButtonBigModel3,
                      updateCallback: () => safeSetState(() {}),
                      child: DarkIconButtonBigWidget(
                        icon: Icon(
                          Icons.facebook,
