...
import '/components/dialog_modals/shipping_type_preffernce/shipping_type_preffernce_widget.dart';
                      ...
                      Column(
                        ...
                        children: [
                          ...
                          Wrap(
                            ...
                            children: [
                              wrapWithModel(
                                model: _model.checkOutOrderListItemModel1,
                                updateCallback: () => safeSetState(() {}),
                                child: const CheckOutOrderListItemWidget(
                                  img:
                                      'https://tm-shopify006-clothes.myshopify.com/cdn/shop/products/buttonless_suede_jacket_1_medium.png?v=1387967661',
                                ),
                              ),
                              wrapWithModel(
                                model: _model.checkOutOrderListItemModel2,
                                updateCallback: () => safeSetState(() {}),
                                child: const CheckOutOrderListItemWidget(
                                  img:
                              ...
                              wrapWithModel(
                                model: _model.checkOutOrderListItemModel3,
                                updateCallback: () => safeSetState(() {}),
                                child: const CheckOutOrderListItemWidget(
                                  img:
                                      'https://tm-shopify006-clothes.myshopify.com/cdn/shop/products/gravel_classic_blouse_shirt_1_medium.png?v=1387967720',
                                ),
                              ),
                              wrapWithModel(
                                model: _model.checkOutOrderListItemModel4,
                                updateCallback: () => safeSetState(() {}),
                                child: const CheckOutOrderListItemWidget(
                                  img:
