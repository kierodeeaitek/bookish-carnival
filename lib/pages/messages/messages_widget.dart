              ...
              children: [
                Container(
                  ...
                  child: Wrap(
                    ...
                    children: [
                      wrapWithModel(
                        model: _model.messageListItemModel1,
                        updateCallback: () => safeSetState(() {}),
                        child: const MessageListItemWidget(),
                      ),
                      wrapWithModel(
                        model: _model.messageListItemModel2,
                        updateCallback: () => safeSetState(() {}),
                        child: const MessageListItemWidget(),
                      ),
                      wrapWithModel(
                        model: _model.messageListItemModel3,
                        updateCallback: () => safeSetState(() {}),
                        child: const MessageListItemWidget(),
                      ),
                      wrapWithModel(
                        model: _model.messageListItemModel4,
                        updateCallback: () => safeSetState(() {}),
                        child: const MessageListItemWidget(),
                      ),
                    ],
