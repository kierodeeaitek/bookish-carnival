...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color tertiary = const Color(0xFFB4C8DA);
  late Color alternate = const Color(0xFFA8AFB8);
  late Color primaryText = const Color(0xFF161C24);
  late Color secondaryText = const Color(0xFF636F81);
  late Color primaryBackground = const Color(0xFFD2DDE7);
...
class DarkModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF2797FF);
  late Color secondary = const Color(0xFF0B67BC);
  late Color tertiary = const Color(0xFF131E2D);
