...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: 'AllReviews',
          path: '/allReviews',
          builder: (context, params) => const AllReviewsWidget(),
        ),
        FFRoute(
          name: 'Wishlist',
          path: '/wishlist',
          builder: (context, params) => params.isEmpty
              ? const NavBarPage(initialPage: 'Wishlist')
        ...
        FFRoute(
          name: 'LeaveReview',
          path: '/leaveReview',
          builder: (context, params) => const LeaveReviewWidget(),
        ),
        FFRoute(
          name: 'OrderDetails',
          path: '/orderDetails',
        ...
        FFRoute(
          name: 'SingleCategory',
          path: '/singleCategory',
          builder: (context, params) => const SingleCategoryWidget(),
        ),
        FFRoute(
          name: 'Chat',
          path: '/chat',
        ...
        FFRoute(
          ...
          builder: (context, params) => const NotificationSettingWidget(),
        ),
        FFRoute(
          name: 'Language',
          path: '/language',
